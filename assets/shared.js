...
// sous-menu : style du premier élément de liste par défaut
...
if($('.item-page.produit').length > 0) {
	//alert($('.item-page.produit').height());
	 ...
	 var titres = $('.item-page h2.showLink').detach();
	  ...
	  //recupération des hauteurs des divs à afficher
	  ...
	  // positionnement des div. Defaut : tableau des formules sauf si lien video demandé (hash video)
